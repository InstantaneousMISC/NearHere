...
import ContactPageInteractiveArea from "@/components/campaign/ContactPageInteractiveArea"
...
export default async function CampaignPage({
  ...
  return (
    <main className="min-h-screen bg-[#FAF8F4] text-[#211D1C] font-sans antialiased">
      <CampaignNav state={state} city={city} slug={slug} isContactPage={false} />
      ...
      {/* Interactive Postcard Preview & Inquiry Section */}
      <ContactPageInteractiveArea
